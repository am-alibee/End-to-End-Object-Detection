...
#             os.system(f"cp yolov5/runs/train/yolov5_results/weights/best.pt {self.model_trainer_config.model_trainer_dir}/")
...
#             logging.info("Exited initiate_model_trainer method of ModelTrainer")
